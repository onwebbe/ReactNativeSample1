...
type Props = {};
export class TravelItemAttraction extends Component<Props> {
  static navigationOptions = ({navigation}) => {
    return topMenuConfig(navigation, '旅行项目 - 景点', true, true)
    //   return {
    //     title: '旅行列表',
    ...
    return (
      <View style={[styles.container, themeing.functionContainerBackground, themeing.pageContainerSecond]}>
        <View style={[styles.travelDetailHead, themeing.bodyCardColorSecond, {paddingLeft: 15, paddingRight: 15, paddingBottom: 10}]}>
            <Text style={[themeing.fontColor, {fontSize: 18, paddingTop: 10}]}>项目内容：悉尼大学</Text>
        ...
        <View style={[styles.travelDetailHead, themeing.bodyCardColorSecond, styles.cardPaddingSize, {marginTop: 8}]}>
            <Text style={[themeing.fontColor, {fontSize: 18}]}>景点介绍</Text>
            <Text style={[themeing.fontColor, {fontSize: 14}]}></Text>
        </View>
